...
<div xmlns="http://www.w3.org/1999/xhtml" id="form-wrapper">
   ...
   <div class="content-box">
      <form name="form_locale" method="post" action="/locales/save.html">
         <ul class="editPanel">
            <li>
               <label class="desc" for="id">id</label>
               <input id="d4e95" name="id" class="field text" value="{response:body()//*:id}"/>
            </li>
            <li>
               <label class="desc" for="name">name</label>
               <input id="d4e102" name="name" class="field text" value="{response:body()//*:name}"/>
            </li>
            <li class="buttons">
               <label/>
