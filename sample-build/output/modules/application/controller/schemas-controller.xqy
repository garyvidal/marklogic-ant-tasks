...
module namespace controller = "http://www.condenast.com/dam/2.0/controller/schemas";
...
import module namespace model = "http://www.condenast.com/dam/2.0/model/schema"
...
declare function controller:create() {
  model:create( 
  request:param("name") , 
  request:param("schemaLocation") , 
  request:param("namespace") , 
  request:param("isPrimary") )
};
...
declare function controller:update()
{
  model:update(
   ...
   request:param("schemaLocation")  cast as xs:string, 
   request:param("namespace")  cast as xs:string, 
   request:param("isPrimary")  cast as xs:boolean
  )
};
