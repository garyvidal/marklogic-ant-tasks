...
module namespace controller = "http://www.condenast.com/dam/2.0/controller/timezones";
...
import module namespace model = "http://www.condenast.com/dam/2.0/model/timezone"
  at "/application/model/timezone-model.xqy";
...
declare function controller:update()
{
  model:update(
   ...
   request:param("offset")  cast as xs:decimal, 
