...
module namespace controller = "http://www.condenast.com/dam/2.0/controller/assetTypes";
...
import module namespace model = "http://www.condenast.com/dam/2.0/model/assetType"
...
declare function controller:create() {
  ...
  request:param("namespace-uri") , 
  request:param("element") , 
  request:param("xmlSchemaLocation") , 
  request:param("isActive") )
};

(:~
 :  Retrieves a assetType
~:) 
...
declare function controller:update()
{
  model:update(
   ...
   request:param("namespace-uri")  cast as xs:string, 
   request:param("element")  cast as xs:string, 
   request:param("xmlSchemaLocation")  cast as xs:string, 
   request:param("isActive")  cast as xs:boolean
  )
};
