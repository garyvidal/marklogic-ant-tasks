...
(:~
 : Controller :  publicationGroups 
 :               
 : @author   
 : @version    
~:)

module namespace controller = "http://www.condenast.com/dam/2.0/controller/publicationGroups";
...
import module namespace model = "http://www.condenast.com/dam/2.0/model/publicationGroup"
  at "/application/model/publicationGroup-model.xqy";
