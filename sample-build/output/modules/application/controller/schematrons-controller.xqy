...
module namespace controller = "http://www.condenast.com/dam/2.0/controller/schematrons";
...
import module namespace model = "http://www.condenast.com/dam/2.0/model/schematron"
...
declare function controller:create() {
  model:create( 
  request:param("name") , 
  request:param("schematronElement") )
};

(:~
 :  Retrieves a schematron
~:) 
