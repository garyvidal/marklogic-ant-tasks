...
<div xmlns="http://www.w3.org/1999/xhtml" id="form-wrapper">
   <div class="inner-page-title">
      <h2>Edit Package Types</h2>
   </div>
   <div class="content-box">
      <form name="form_packageType" method="post" action="/packageTypes/save.html">
         <ul class="editPanel">
            <li>
               <label class="desc" for="id">id</label>
               <input id="d4e202" name="id" class="field text" value="{response:body()//*:id}"/>
            </li>
            <li>
               <label class="desc" for="name">name</label>
               <input id="d4e209" name="name" class="field text" value="{response:body()//*:name}"/>
            </li>
            <li class="buttons">
               <label/>
